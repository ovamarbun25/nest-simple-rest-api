...
describe('App e2e', () => {
  ...
  describe('Auth', () => {
    ...
    describe('Signup', () => {
      //THROW
      it('Should throw an error if both email and password are empty (no body)', () => {
        return pactum
          .spec()
          .post('/auth/signup')
          .expectStatus(400);
  ...
  describe('Bookmarks', () => {
    ...
    describe('Edit bookmark by id', () => { 
      const dto: EditBookmarkDto = {
        title: 'New The First Bookmark',
        description: 'This is the first description of the The First Bookmark'
      }
